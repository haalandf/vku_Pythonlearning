...
os.chdir(r"D:\python\vku_Pythonlearning\data")
...
numpy.save('n0.npy', n0)
numpy.save('nN.npy', nN)
numpy.save('nS.npy', nS)
numpy.save('nE.npy', nE)
numpy.save('nW.npy', nW)
numpy.save('nNE.npy', nNE)
numpy.save('nSE.npy', nSE)
numpy.save('nNW.npy', nNW)
numpy.save('nSW.npy', nSW)
print('done!')
